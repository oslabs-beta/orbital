...
const clusterController = {
  ...
  async deleteCluster(req, res, next) {
    try {
      ...
      error.message = 'Error in clusterController.deleteCluster middleware.';
      return next(error);
    }
  },
  async getUserClusters(req, res, next) {
    try {
      ...
      err.message = 'Error in ClusterController.getUserClusters middleware.';
      return next(err);
    }
  },
  async getClusterById(req, res, next) {
    try {
      ...
      err.message = 'Error in ClusterController.getClusterById middleware.';
      return next(err);
    }
  },
};
