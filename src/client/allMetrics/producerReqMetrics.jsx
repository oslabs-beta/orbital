...
const ProducerReqMetrics = ({ prodReqMetrics }) => {
  ...
  useEffect(() => {
    ...
    const chart = new Chart(chartCtx, {
      ...
      data: {
        ...
        datasets: [
          {
            label: 'Producer Requests per second',
            data: bytesInData,
  ...
  return (
    <Card sx={{ width: 500, boxShadow: '0px 0px 4px black' }}>
      <CardHeader title='Producer Requests' style={{ textAlign: 'center' }} />
      <canvas ref={chartRef} style={{ width: 500 }} />
    </Card>
  );
};

export default ProducerReqMetrics;
